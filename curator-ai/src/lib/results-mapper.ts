...
/** Verification status bands (must match verification_service.py). */
export const STATUS_VERIFIED = "Verified";
export const STATUS_LIKELY = "Likely Correct";
export const STATUS_REVIEW = "Needs Manual Review";
...
/** Tailwind classes for a status badge, keyed by status band. */
